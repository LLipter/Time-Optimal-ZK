...
In the query phase, the verifier $\mathcal{V}$ can query $M_0^\prime$ at position $(0, 0, 0)$. Then the verifier $\mathcal{V}$ can query $PAD_0^\prime$ at position $(0, N, 0)$. 
...
\begin{definition}[$l$-query zero-knowledge codeword]
